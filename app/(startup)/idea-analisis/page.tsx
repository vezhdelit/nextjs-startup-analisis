...
import InputTables from "@/components/startup/idea/EvaluationInputTables";
import ModelOneTable from "@/components/startup/idea/ModelOneTable";
import StartupEvaluationView from "@/components/startup/idea/StartupEvaluationView";
import UTable from "@/components/startup/idea/UTable";
import EvaluationTable from "@/components/startup/idea/EvaluationTable";
import { Button } from "@/components/ui/button";

import { startupEvaluation } from "@/lib/idea";
import { useEffect, useState } from "react";

const IdeaAnalisisPage = () => {
...
export default IdeaAnalisisPage;
